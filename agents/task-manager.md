# Task Manager Agent -- Aerobiz Session Coordinator
...
Task(
    ...
    description="Engineer: <task name>"
)
```

After each major Engineer phase (analysis complete / translation complete / proposal ready),
...
When the Engineer outputs an Auditor sign-off request (any proposal touching VDP DMA,
Z80 bus, interrupt handlers, or memory map changes):
