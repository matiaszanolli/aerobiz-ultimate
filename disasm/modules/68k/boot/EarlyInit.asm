...
TMSSFontTiles:                                                  ; $003D98
    ...
    dc.w    $3880,$B453,$6332,$9453,$3013,$D040,$247C    ; $003F90
    dc.l    ROM_BASE+$04684C    ; movea.l operand
    dc.w    $3632,$0000,$C655,$0283,$0000,$FFFF,$3003    ; $003FA2
    dc.w    $E568,$8154,$1029,$0001,$E148,$1011,$3A80,$5489; $003FB0
    dc.w    $7010,$9042,$3680,$6002,$9553,$7000,$3013,$7200; $003FC0
    dc.w    $3215,$E0A1,$2001,$3202,$D241,$247C    ; $003FD0
    dc.l    ROM_BASE+$04684C    ; movea.l operand
